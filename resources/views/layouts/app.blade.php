...
<nav class="navbar navbar-expand-md navbar-expand-sm  navbar-light navbar-laravel navbar-fixed-top">
  <div class="container col-sm-12">
    <a class="navbar-brand" href="#">
      <div id="contenaireClapiers">
        <img src="{{ asset('/images/logo_clapiers_header.png')}}" alt="logo de la ville de Clapiers">
      </div>
      <div id="contenaireGAC">
        <img src="{{ asset('/images/logoBlanc.png')}}" alt="logo de GAC Clapiers">
        <h1>Gymnastique Artistique Clapiéroise</h1>
      </div>
      <div id="contenaireUFPLEP">
        <img src="{{asset('/images/logoufoleptransparent.png')}}" alt="logo de l'UFOLEP">
      </div>
    </a>
  ...
  <ul class="nav nav-tabs nav-justified menu ">
    <li class="active menu fondRose"><a href="{{ route('accueil') }}" class="rose">Accueil</a></li>
    <li class="bandeBleu menu"><a href="{{ route('baby') }}"class="Bleu">Baby Gym</a></li>
    <li class="bandeViolette menu"><a href="{{ route('GA') }}" class="Violette">Gymnastique Artistique</a></li>
    <li class="bandeHotpink menu"><a href="{{ route('adulte') }}" class="Hotpink">Gym'Adulte</a></li>
    <li class="bandeCyan menu"><a href="{{ route('pilates') }}" class="Cyan">Pilates</a></li>
    <li class="bandeJaune menu"><a href="{{ route('zumba') }}" class="Jaune">Zumba</a></li>
    <li class="bandeRouge menu"><a  href="{{ route('adherent.create') }} Rouge">Inscription</a></li>
  </ul>
</nav>
...
<footer>
  ...
  <div id="contenaireGAC2">
    <img src="{{ asset('/images/logoGAC2.png')}}">
  </div>
</footer>
