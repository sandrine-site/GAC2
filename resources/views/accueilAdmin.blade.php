                        ...
                        <div class="tab-content">
                            <div id="accueil" class="tab-pane fade-in active">
                                ...
                                <div class=" row display-7">
                                    <a href="{!!route('groupe.index')!!}" class="btn btn-info "><span
                                            class="fas fa-users-cog"></span> Composer
                                        des groupes gym</a>
                                    <a href="{!!route('section.index')!!}" class="btn btn-success  "><span
                                            class="fas fa-table"></span> Edition des sections</a>
                                    <a href="{!!route('creneau.index')!!}" class="btn btn-dark "><span
                                            class="far fa-clock"></span> Gestion des creneaux horaire</a>
                                </div>
                                <br/>
                                <div class=" row display-7">
                                    <a href="{!!route('dossier.index')!!}" class="btn btn-vert1 "><span
                                            class="far fa-file-alt"></span> gestion
                                        des dossiers</a>
                                    <a href="#" class="btn btn-vert2 "><span
                                            class="fas fa-money-bill-wave"></span>
                                        Gestion des encaissements</a>
                                    <a href="{!!route('dossier.index')!!}" class="btn btn-warning "><span
                                            class="far fa-file-alt"></span> Gestion des autorisations</a>
                                </div>
                                <br/>
                                <div class=" row display-7">
                                    <a href="{!!route('user.index')!!}" class="btn btn-bleu1  "><span
                                            class="far fa-address-book"></span> Liste des administrateurs</a>
                                    <a href="{!!route('anneeScolaire.store')!!}" class="btn btn-bleu2  "><span
                                            class="fas fa-history"></span> Changer l'année </a>
                                </div>
                            </div>

                            <div id="tous" class="tab-pane fade">
                                <div class="row ">
                                    <div class="col-10">
