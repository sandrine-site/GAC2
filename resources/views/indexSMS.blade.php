    ...
    <div class="col-8">
      <div class="card" id="app">
        ...
        Vous pouvez rédiger votre message ici:
          <textarea class="sms" name="contenu" >
          </textarea>
        </div>
        <div class="card-body section5" >
        ...
        <div class="row justify-content-between">
         ...
         <input type="checkbox" name="respLegal" id="respLegal" value="respLegal">
         <label for="respLegal">Au responsable légal</label><br/>
         <input type="checkbox" name="adherent" id="adherent" value="adherent">
         <label for="adherent">A l'adhérent</label>
        </div>
         <br/>
         <div class="row justify-content-center ">
