            ...
            <div class="col-md-12">
                <div class="card liste">
                    <div class="card-header">
                            <span class="card-header display-6">Liste des gymnastes s'entrainant le {{$creneau->jour->jour}} à {{$creneau->heure_debut}} h  {{$creneau->min_debut}} pendant {{$creneau->duree}} </span>
