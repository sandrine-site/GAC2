            ...
            <div class="col-md-12">
                <div class="card liste">
                    <div class="card-header">
                        ...
                        @if(isset($groupe))
                            <span class="card-header display-6">Liste des gymnastes du groupe {{$groupe->nom}}</span>
                            @elseif(isset($section))
                            <span class="card-header display-6">Liste des gymnastes de la section {{$section->nom}}</span>
                            @elseif(isset($entraineur))
                            <span class="card-header display-6">Liste des gymnastes s'entrainant avec {{$entraineur->prenom}}</span>
                            @endif
                                    ...
                                    <tr>
                                        ...
                                        <td class="entrainement">
                                            @foreach ($adherent->creneaux as $creneau)
                                                le {{$creneau->jour}} à {{$creneau->heure_debut}}h{{$creneau->min_debut}}
                                            @endforeach
                                        </td>
                                        <td class="entrainement">
