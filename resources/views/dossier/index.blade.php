                    ...
                    <form
                        ...
                        <table class="dossier">
                            ...
                            <tr v-for="adherent in adherents.data ">
                                ...
                                <td>
                                    <input type='checkbox' @click='checkAll(adherent)'  v-model='adherent.isCheckAll'></td>
                                <td>
                                    <input type='checkbox' name="CertifMedical" v-bind:value='adherent.CertifMedical' v-model='adherent.CertifMedical' @change='updateCheckallCertifMedical(adherent)'>
                                </td>
                                <td>
                                    <input type='checkbox' v-bind:value='adherent.photo' v-model='adherent.photo' @change='updateCheckallphoto(adherent)'>

                                </td>
                                <td>
                                    <input type='checkbox' v-bind:value='adherent.autorisationsRendues' v-model='adherent.autorisationsRendues' @change='updateCheckallautorisationsRendues(adherent)'>

                                </td>
                                <td>
                                    <input type='checkbox' v-bind:value='adherent.RecuDemande' v-model='adherent.RecuDemande'  @change='updateRecuDemande(adherent)'>
                                </td>
